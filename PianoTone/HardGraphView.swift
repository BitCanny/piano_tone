...
class HardGraphView: UIView {
    ...
    func drawKeysWithArray(keyArray : [String]){
        ...
        for var i = 0; i < keyArray.count; ++i{
            ...
            if appDelegate.isHardOnTrible == true{
            if firstNumber < 8 || (firstNumber >= 10 && firstNumber <= 19)   {
                ...
                if firstNumber < 8 || firstNumber ==  19   {
                    path.moveToPoint(CGPointMake(imageView.frame.origin.x+imageView.frame.size.width-1, imageView.center.y-3*blockHeight))
                    path.addLineToPoint(CGPointMake(imageView.frame.origin.x+imageView.frame.size.width-1,  imageView.center.y))
...
//            if firstNumber < 8 || (firstNumber > 16 && firstNumber < 20 ){
//                path.moveToPoint(CGPointMake(imageView.frame.origin.x+imageView.frame.size.width-1, imageView.center.y-3*blockHeight))
//                path.addLineToPoint(CGPointMake(imageView.frame.origin.x+imageView.frame.size.width-1,  imageView.center.y))
//                NSLog("1,FirstNumber=%d",firstNumber)
//                
//            }
//            else{
//                path.moveToPoint(CGPointMake(imageView.frame.origin.x,  imageView.center.y))
...
//            }
    ...
    func drawUI(){
        ...
        blockHeight = rect.size.height/(10+2+8+12)
        ...
        NSLog("Base=%@,trible=%@", bassArray,tribleArray)
    ...
    func getNoteCenter(keyNo : Int,sequenceNo : Int)->CGPoint{
        ...
        case 10:
            ...
            keyCenter = CGPointMake(keyCenterArray[sequenceNo], tribleArray[10])
            cutLineArray.append(CGPointMake(keyCenterArray[sequenceNo], tribleArray[10]))
            ...
            break
        case 11:
            keyCenter = CGPointMake(keyCenterArray[sequenceNo], (tribleArray[10]+tribleArray[9])/2)
            cutLineArray.append(CGPointMake(keyCenterArray[sequenceNo], tribleArray[9]))
            cutLineArray.append(CGPointMake(keyCenterArray[sequenceNo], tribleArray[8]))
            break
        case 12:
        ...
        return keyCenter
            ...
            case 0:
                keyCenter = CGPointMake(keyCenterArray[sequenceNo], bassArray[10])
                cutLineArray.append(CGPointMake(keyCenterArray[sequenceNo], bassArray[10]))
                cutLineArray.append(CGPointMake(keyCenterArray[sequenceNo], bassArray[9]))
                
                break
            case 1:
                keyCenter = CGPointMake(keyCenterArray[sequenceNo], (bassArray[10]+bassArray[9])/2)
                cutLineArray.append(CGPointMake(keyCenterArray[sequenceNo], bassArray[9]))
            ...
            case 14:
                ...
                cutLineArray.append(CGPointMake(keyCenterArray[sequenceNo], bassArray[3]))
                break
            case 15:
